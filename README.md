...
- **BioOSS: A Bio-Inspired Oscillatory State System with Spatio-Temporal Dynamics** — *NeurIPS*, 2025.

### Related Reference

- Learning to Dissipate Energy in Oscillatory State-Space Models — *arXiv preprint*, 2025.
...
- **Neural Wave Machines: Learning Spatiotemporally Structured Representations with Locally Coupled Oscillatory Recurrent Neural Networks** — *ICML*, 2023.
- **Traveling Waves Encode The Recent Past and Enhance Sequence Learning** — *ICLR*, 2024.
